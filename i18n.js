...
const DICT = {
  ...
  'app.title':               { he: 'תהילהון',                en: 'Tehillon' },
  ...
  'home.btn_saved':          { he: 'פסוקים<br>שמורים',        en: 'Saved<br>Verses' },
  ...
  'home.mode_simple':        { he: '📖 עבור לקריאה תמימה',     en: '📖 Simple reading' },
  ...
  // ברכות
  'bless.title':             { he: '🙏 ברכות קריאת תהילים',   en: '🙏 Tehillim Blessings' },
  'bless.font_size':         { he: 'גודל פונט:',              en: 'Font size:' },
  'bless.before':            { he: 'לפני קריאת תהילים',       en: 'Before reading' },
  'bless.after_short':       { he: 'אחרי קריאת תהילים',       en: 'After reading' },
  'bless.hida':              { he: 'יהי רצון של החיד"א (אחרי הקריאה)', en: 'Hida\'s Yehi Ratzon' },
  ...
  'sel.read_now':            { he: 'קרא עכשיו ←',             en: 'Read now ←' },
  'sel.cycle_sub':           { he: 'קרא את כל ספר תהילים',    en: 'Read entire Tehillim' },
  'sel.cycle_resume':        { he: 'ממשיך מהמקום שעצרת',       en: 'Resuming where you left off' },
  'sel.seq_sub':             { he: 'בחר פרקים לקריאה',         en: 'Pick chapters to read' },
  'sel.seq_create':          { he: 'צור רצף משלך ←',           en: 'Create your own ←' },
  'sel.my_chap_freq':        { he: '⭐ פתיחת הפרק שלי',        en: '⭐ My chapter prompt' },
  'sel.hida_title':          { he: '🕯 קריאת תהילים לפי שם',   en: '🕯 Reading by name' },
  ...
  'sel.cycle':               { he: 'סבב פרקים',               en: 'Cycle' },
  'sel.cycle_sub':           { he: 'קרא את כל ספר תהילים',    en: 'Read entire Tehillim book' },
  'sel.sequence':            { he: 'מחולל רצף',               en: 'Sequence Builder' },
  'sel.sequence_sub':        { he: 'בחר פרקים לקריאה',         en: 'Pick chapters to read' },

  // קורא (03-reader)
  'reader.time':             { he: 'זמן קריאה',               en: 'Reading time' },
  ...
  'hist.chaps_today':        { he: 'פרקים נקראו',             en: 'Chapters read' },
  'hist.reading_time':       { he: 'זמן קריאה',               en: 'Reading time' },
  'hist.points':             { he: 'מעלות',                   en: 'Maalot' },
  'hist.chaps_today_title':  { he: 'פרקים שנקראו היום',        en: 'Chapters read today' },
  'hist.last_7_days':        { he: '7 הימים האחרונים',        en: 'Last 7 days' },
  'hist.delete_today':       { he: '🗑 מחק נתוני קריאה של היום', en: '🗑 Delete today\'s reading data' },
  ...
  'set.dark_mode_sub':       { he: 'רקע כהה לקריאה בחושך',    en: 'Dark background for night reading' },
  'set.font_size':           { he: 'גודל גופן בקריאה',        en: 'Reading font size' },
  ...
  'set.reading':             { he: 'קריאה',                   en: 'Reading' },
  ...
  'sel.read_first_day':      { he: '📖 קרא פרק ראשון מהיום',   en: '📖 Read first chapter of today' },
  'sel.by_name_title':       { he: '🕯 קריאת תהילים לפי שם',    en: '🕯 Read Tehillim by name' },
  'sel.by_name_intro':       { he: 'מנהג קדום של החיד"א — לקרוא תהילים לרפואת/לעילוי נשמת אדם, על פי אותיות שמו.', en: 'Ancient Chida custom - reading Tehillim by letters of a name.' },
  ...
  'reader.share_verse':      { he: 'שתף פסוק',                en: 'Share verse' },
  'reader.save_verse':       { he: 'שמור פסוק',               en: 'Save verse' },
  ...
  'hist.books_5':            { he: '5 ספרי תהילים',           en: '5 Books of Tehillim' },
  ...
  'set.verse_nums':          { he: 'מספרי פסוקים',            en: 'Verse numbers' },
  'set.verse_nums_sub':      { he: 'הצג מספר לצד כל פסוק',    en: 'Show verse numbers' },
  ...
  'set.backup_note':         { he: 'הגיבוי כולל את כל הנתונים: קריאות, ניקוד, מועדפים ושינון.', en: 'Backup includes: readings, scores, favorites, memorized.' },
  ...
  'set.my_chap_banner':       { he: 'באנר "הפרק שלי"',           en: '"My chapter" banner' },
  ...
  'set.what_is_tehilim':      { he: 'מהו תהילים? הסבר למתחילים', en: 'What is Tehillim?' },
  ...
  'comm.chaps_today':        { he: '📖 פרקים נקראו היום',     en: '📖 Chapters read today' },
  'comm.mins_today':         { he: '⏱ דקות קריאה היום',       en: '⏱ Minutes today' },
  ...
  'saved.title':             { he: '🔖 פסוקים שמורים',         en: '🔖 Saved verses' },
  'saved.empty':             { he: 'אין עדיין פסוקים שמורים', en: 'No saved verses yet' },
  ...
  'seq.all_psalms':          { he: '📜 כל התהילים',           en: '📜 All Tehillim' },
  'seq.favs':                { he: '❤️ מועדפים',              en: '❤️ Favorites' },
  'seq.today':               { he: '📅 של היום',              en: '📅 Of today' },
  'seq.clear':               { he: '✕ נקה',                   en: '✕ Clear' },
  'seq.hint':                { he: 'לחץ על פרק להוסיפו לרצף · לחץ שנית להסירו', en: 'Tap to add · tap again to remove' },
  ...
  'comm.mission_sub':        { he: 'סיום ספר תהילים יחד',             en: 'Finish Tehillim together' },
  ...
  'group.list_sub':          { he: 'קרא תהילים יחד עם משפחה, חברים וחברותא', en: 'Read Tehillim together with family, friends & chavruta' },
  ...
  'yizkor.ph_psalm':        { he: 'או הכנס מספר פרק (1–150)…',                  en: 'Or enter chapter number (1–150)…' },
  'yizkor.share_request':   { he: '💬 שתף בקשה לקריאת תהילים',                  en: '💬 Share Psalm Reading Request' },
  'yizkor.to_prayers':      { he: 'לתפילות ✨',                                  en: 'To Prayers ✨' },
  'yizkor.role_pre':        { he: 'פרקים לפני השם',                              en: 'Psalms before name' },
  ...
  'group.book_label':        { he: 'בחר ספר',                  en: 'Select book' },
  'group.range_label':       { he: 'מספרי פרקים (מ-עד)',       en: 'Chapter range (from-to)' },
  ...
  'group.book_a':            { he: 'ספר א׳ (1-41)',            en: 'Book I (1-41)' },
  'group.book_b':            { he: 'ספר ב׳ (42-72)',           en: 'Book II (42-72)' },
  'group.book_c':            { he: 'ספר ג׳ (73-89)',           en: 'Book III (73-89)' },
  'group.book_d':            { he: 'ספר ד׳ (90-106)',          en: 'Book IV (90-106)' },
  'group.book_e':            { he: 'ספר ה׳ (107-150)',         en: 'Book V (107-150)' },
  'group.type_book':         { he: 'ספר שלם מתוך 5 ספרי תהילים', en: 'A whole book of the 5 Tehillim books' },
  'group.type_all':          { he: 'כל ה-150 פרקים',           en: 'All 150 chapters' },
  'group.type_day':          { he: 'פרקי תהילים של היום',      en: "Today's Tehillim chapters" },
  'group.type_range':        { he: 'טווח פרקים מותאם',         en: 'Custom range' },
  'sel.daily_song_sub':      { he: 'קרא עכשיו ←',             en: 'Read now ←' },
