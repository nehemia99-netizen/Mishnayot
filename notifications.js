/* ════════════════════════════════════════════════════════════
   תהילהון — מודול תזכורות (Notifications) v2.2.50
   ──────────────────────────────────────────────────────────────
...
const LIBRARY = [
  { title:'תהילהון — זמן לקריאת תהילים', body:'"שָׂשׂ אָנֹכִי עַל אִמְרָתֶךָ כְּמוֹצֵא שָׁלָל רָב" — בוא נקרא פרק' },
  { title:'תהילהון — דקה לתהילים?', body:'אפילו פרק קצר ביום עושה את ההבדל. לחץ כדי להתחיל' },
  { title:'🕯️ תהילהון', body:'תהילים מבטל גזירות. ניצול דקה אחת — בקלות' },
  { title:'📖 הזמן הוא עכשיו', body:'"מָה אָהַבְתִּי תוֹרָתֶךָ, כָּל הַיּוֹם הִיא שִׂיחָתִי"' },
  { title:'⭐ הרצף שלך מחכה', body:'אל תשבור את הרצף — קרא פרק קצר עכשיו' },
  { title:'🎯 אתגר היום מחכה', body:'יש לך אתגר פעיל — בוא נשלים אותו' },
  { title:'🙏 רגע של רוחניות', body:'דוד המלך בז"ל קרא תהילים בכל יום. בוא נקרא איתו' },
  { title:'📜 פתח פרק אקראי', body:'תן לקב"ה להפתיע אותך עם הפרק המתאים לרגע' }
];
