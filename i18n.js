...
const DICT = {
  ...
  'set.verse_nums':          { he: 'מספרי משניות',            en: 'Verse numbers' },
  'set.verse_nums_sub':      { he: 'הצג מספר לצד כל משנה',    en: 'Show verse numbers' },
  ...
  'group.type_book':         { he: 'ספר שלם מתוך 6 סדרי המשנה', en: 'A whole book of the 5 Tehillim books' },
